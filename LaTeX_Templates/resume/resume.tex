...
% the `\rule{length}{width}`
% `\\` starts a new line
% `includegraphics[scale]{file name}

\lhead{\vtop{\textbf{\LARGE{Your Name Here}}\\\rule{3.5in}{2pt}}}
%\chead{\includegraphics[scale=.15]{sig1}}
\rhead{\vtop{info @ example.org\\ +57 313 522 1008 \includegraphics[scale=.0075]{WA_icon}}}
\rfoot {}
\lfoot {}
\cfoot {}
...
% You will see the following command oftent
% It creates vertical space `\vspace{height}`

%\vspace{-.25cm}


% Don't forget to end what you begin ;)
...
% Not using headings so this is commented-out
...
%\item
%	\ressubheading{Organization Name}{Location}{Position}{Start - End}
%	\begin{itemize}[label={--}]
%        \resitem{What did you do?}
%		\resitem{What did you like most?}\\
%	\end{itemize}
%\vspace{.25cm}
...
% THIS IS ACTUALLY ALL BEING COMMENTED OUT!!!

\begin{comment} % <<< THERE IS WHERE IT STARTS
\begin{tabular}
{ c | c }
%{\textwidth}{XX}
...
What began as a means for me to learn coding is now a project to help others learn to code, while increasing civic access and awareness!	
    }%
...
\end{comment} % <<< HERE THE COMMENTING ENDS
...
% Notice that we are using a different format for our items
